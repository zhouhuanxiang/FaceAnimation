#ifndef EIGEN_BINARY_IO_zhx
#define EIGEN_BINARY_IO_zhx
...
void Serialize(SparseMatrix<double>& m, string filename);

template <typename TT>
void Deserialize(SparseMatrix<double>& m, string filename);
